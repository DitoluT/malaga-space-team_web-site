/**
 * ====================================
 * 🔐 PÁGINA DE LOGIN - INVENTARIO
 * ====================================
 * 
 * Sistema de autenticación para el inventario
 * del Málaga Space Team
 */
...
export const InventoryLogin: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('Error de conexión con el servidor. Asegúrate de que el servidor esté ejecutándose.');
    } finally {
      setLoading(false);
    }
  };
