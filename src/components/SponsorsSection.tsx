      ...
      <div className="max-w-7xl mx-auto">
        <GlassContainer className="section-glass mb-16">
          <div className="p-12 text-center">
            <h2 className="text-5xl font-bold text-white mb-8">Nuestros Colaboradores</h2>
              ...
              <div className="p-6 md:p-8 lg:p-12">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-center">
                  ...
                  <div className="text-center lg:text-left">
                    <div className={`inline-flex w-16 h-16 md:w-20 md:h-20 bg-gradient-to-br ${collaborator.color} rounded-full items-center justify-center mb-4 md:mb-6`}>
                      <collaborator.icon className="w-8 h-8 md:w-10 md:h-10 text-white" />
                    </div>
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-2">{collaborator.name}</h3>
                    <p className="text-base md:text-lg font-semibold text-blue-300 mb-4">{collaborator.role}</p>
                    <a 
                      href={collaborator.website}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center space-x-2 text-white/80 hover:text-white transition-colors group text-sm md:text-base"
                    >
